...
import * as VanJSFeather from '../src';
  ...
  return main(
    ...
    ...Icons.map(([name, icon]) =>
      div(
        {
          class:
            'flex flex-col items-center flex-[0_0_auto] w-auto min-w-32 p-3 m-1 rounded-[5px] bg-slate-50 hover:bg-slate-100 dark:bg-slate-950 dark:hover:bg-slate-900',
        },
