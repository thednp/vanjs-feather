...
(function(global, factory) {
	...
	const Archive = (props) => {
		const { polyline, line, rect } = vanjs_core.default.tags(svgNamespace);
	...
	const ArrowDownCircle = (props) => {
		const { polyline, circle, line } = vanjs_core.default.tags(svgNamespace);
		return FeatherIcon(props, circle({
			cx: "12",
			cy: "12",
			r: "10"
	...
	const Award = (props) => {
		const { polyline, circle } = vanjs_core.default.tags(svgNamespace);
		return FeatherIcon(props, circle({
			cx: "12",
			cy: "8",
			r: "7"
	...
	const Codepen = (props) => {
		const { polyline, polygon, line } = vanjs_core.default.tags(svgNamespace);
	...
	const Compass = (props) => {
		const { polygon, circle } = vanjs_core.default.tags(svgNamespace);
		return FeatherIcon(props, circle({
			cx: "12",
			cy: "12",
			r: "10"
	...
	const Gift = (props) => {
		const { polyline, path, line, rect } = vanjs_core.default.tags(svgNamespace);
	...
	const Image = (props) => {
		const { polyline, circle, rect } = vanjs_core.default.tags(svgNamespace);
		return FeatherIcon(props, rect({
			x: "3",
			y: "3",
			width: "18",
	...
	const Instagram = (props) => {
		const { path, line, rect } = vanjs_core.default.tags(svgNamespace);
		return FeatherIcon(props, rect({
			x: "2",
			y: "2",
			width: "20",
	...
	const Layers = (props) => {
		const { polyline, polygon } = vanjs_core.default.tags(svgNamespace);
	...
	const Speaker = (props) => {
		const { circle, line, rect } = vanjs_core.default.tags(svgNamespace);
		return FeatherIcon(props, rect({
			x: "4",
			y: "2",
			width: "16",
	...
	const Truck = (props) => {
		const { polygon, circle, rect } = vanjs_core.default.tags(svgNamespace);
		return FeatherIcon(props, rect({
			x: "1",
			y: "3",
			width: "15",
	...
	const Tv = (props) => {
		const { polyline, rect } = vanjs_core.default.tags(svgNamespace);
		return FeatherIcon(props, rect({
			x: "2",
			y: "7",
			width: "20",
	...
	const UserCheck = (props) => {
		const { polyline, path, circle } = vanjs_core.default.tags(svgNamespace);
